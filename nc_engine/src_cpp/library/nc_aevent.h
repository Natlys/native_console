...
namespace NC
{
	...
	struct NC_API MouseEvent : public AEvent
	{
	public:
	...
	struct NC_API KeyboardEvent : public AEvent
	{
	public:
		// ReleaseEvent
	...
	struct NC_API WindowEvent : public AEvent
	{
	public:
	...
	public:
		...
		// WindowResizeEvent
		WindowEvent(EventTypes wevType, Int32 nWidth, Int32 nHeight) :
			AEvent(wevType), nWidth(nWidth), nHeight(nHeight) {}
	};
}
