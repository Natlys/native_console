...
namespace NC
{
	...
	enum MouseButtons : UInt16 {
		MSB_LEFT = NC_MS_BTN_LEFT, MSB_RIGHT = NC_MS_BTN_RIGHT,
		MIDDLE = NC_MS_BTN_MIDDLE,
		MSB_ADD_1 = NC_MS_BTN_3, MSB_ADD_2 = NC_MS_BTN_4,
		MSB_LAST = NC_MS_BTN_LAST, MSB_COUNT = NC_MS_BTN_COUNT
	};
	enum KeyCodes : WChar {
		KC_NONE = 0,
	...
	enum EventCategories : UInt16 {
		EC_FOCUS = NC_FOCUS_EVT, EC_WINDOW_SIZE = NC_WND_SIZE_EVT, EC_MENU = NC_MENU_EVT,
		EC_MOUSE = NC_MS_EVT, EC_KEYBOARD = NC_KEY_EVT,
	};
	enum EventTypes : UInt16 {
		ET_MOUSE_MOVED = NC_MS_MOVED, ET_VSCROLL = NC_MS_WHEELED, ET_HSCROLL = NC_MS_HWHEELED,
	};
}
