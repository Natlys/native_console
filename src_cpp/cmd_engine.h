...
<<<<<<< HEAD
		inline UInt16 GetMouseMoveX()				{ return static_cast<UInt16>(m_cevInfo.msInfo.xMove); }
		inline UInt16 GetMouseMoveY()				{ return static_cast<UInt16>(m_cevInfo.msInfo.yMove); }
		inline UInt16 GetMouseHeldX(UInt16 msCode)	{ return static_cast<UInt16>(m_cevInfo.msInfo.xHeld[msCode]); }
		inline UInt16 GetMouseHeldY(UInt16 msCode)	{ return static_cast<UInt16>(m_cevInfo.msInfo.yHeld[msCode]); }
